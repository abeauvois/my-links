...
import { GoogleGmailClient } from '../../adapters/GmailClient.js';
    ...
    test('should filter messages by sender email when filterEmail is provided', async () => {
        ...
        const messages = [
            ...
            new GmailMessage(
                ...
                'Marketing email',
                'Raw content of newsletter email'
            ),
            new GmailMessage(
                '3',
                ...
                'Raw content of another personal email'
            ),
            new GmailMessage(
                '4',
                'Work email',
        ...
        const useCase = new GoogleGmailClient();
        'your-client-id',
            'your-client-secret',
            'your-refresh-token',
            console // Using console as a simple logger
        );
